        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="salesreps/new">Create a new Sales Rep</NavLink>
              </li>
              <li className="nav-item">
              ...
              <li className="nav-item">
                <NavLink className="nav-link" to="salesrecords/new">Create a Sales Record</NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="salesrecords/">List of Sales Records</NavLink>
              </li>
              <li className="nav-item">
                <NavLink className="nav-link" to="targetedrecords/">Targeted Sales Records</NavLink>
              </li>
          </ul>
        </div>
      </div>
